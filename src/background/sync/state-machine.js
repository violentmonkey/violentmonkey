...
// The repo/project itself could not be found (or isn't accessible to the
// token) — distinct from SYNC_ERROR_INIT so the UI can show an actionable
// "create the repository first" message instead of a generic init failure.
// See @usync/drive's RepoNotFoundError, thrown by the gitcontents provider.
export const SYNC_ERROR_REPO_NOT_FOUND = 10;
...
const stateMap = {
  ...
  [SYNC_UNAUTHORIZED]: [SYNC_AUTHORIZING, SYNC_INITIALIZING],
